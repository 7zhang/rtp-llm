...
def analyze(run_dir: Path, master_config: Path | None) -> dict:
    ...
    return {
        ...
        "master": {
            "actual_send_qps": summary.get("actual_send_qps", summary.get("send_qps", 0.0)),
            "arrival_qps": server_latency.get("arrival_qps", summary.get("server_arrival_qps", 0.0)),
            "completion_qps": server_latency.get("completion_qps", summary.get("server_completion_qps", 0.0)),
